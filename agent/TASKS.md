...
| **T-0013** | **Worker pool, SAB vs transfer, tile-sized jobs** | **Grok** | **Partial** | **P0** | Tile sizes 8 KB–50 MB measured in Node; REQUIRED/PREFERRED/UNNECESSARY rules in `docs/M1-MEASUREMENTS.md`. **Still open:** browser table, COOP/COEP on vs off, 1/4/8 workers identical |
